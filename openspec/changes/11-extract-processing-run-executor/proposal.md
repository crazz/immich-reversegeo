...
- Preserve the exact administrative-first/airport-second resolution order, current fallback rules, query semantics, batch cursor/delay behavior, independent per-asset writes, partial-run effects, cancellation taxonomy, diagnostics, and event lifecycle established by blocks 6–10.
