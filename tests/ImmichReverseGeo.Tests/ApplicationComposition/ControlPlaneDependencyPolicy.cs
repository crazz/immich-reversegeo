...
internal static class ControlPlaneDependencyPolicy
{
    ...
    [
        ...
        typeof(ImmichReverseGeo.Web.Services.AppearanceApplier),
        ...
        typeof(ImmichReverseGeo.Web.Services.ExistenceProcessingWorkDetector),
        typeof(ImmichReverseGeo.Web.Services.InstrumentedProcessingWorkDetector),
        ...
        typeof(ImmichReverseGeo.Web.Services.IAppearanceDocument),
        typeof(ImmichReverseGeo.Web.Services.IBrowserColorScheme),
        ...
        typeof(ImmichReverseGeo.Web.Services.IScheduledRunWorkProbe),
        typeof(ImmichReverseGeo.Web.Services.IProcessingWorkDetector),
        ...
        typeof(ImmichReverseGeo.Web.Services.JsAppearanceDocument),
        typeof(ImmichReverseGeo.Web.Services.JsBrowserColorScheme),
    ...
    [
        typeof(WebApplicationBuilder), typeof(WebApplication), typeof(IServer), typeof(EndpointDataSource),
            ...
            typeof(IProcessingScheduleConfiguration), typeof(IScheduledRunTrigger), typeof(IProcessingWorkDetector),
            typeof(ExistenceProcessingWorkDetector),
            typeof(InstrumentedProcessingWorkDetector),
            typeof(IScheduledRunWorkProbe), typeof(WorkerCommandAmbientRuntimeObservationSource),
    ...
    [
        ...
        new(typeof(AppearanceApplier), "appearance", "Document theme apply and Auto scheme subscription; no geodata.", "Web Settings"),
        new(typeof(IAppearanceDocument), "appearance document", "Sets html data-theme only.", "Web Settings"),
        new(typeof(IBrowserColorScheme), "browser scheme", "matchMedia color-scheme signal for Auto Appearance.", "Web Settings"),
        new(typeof(JsAppearanceDocument), "appearance document JS", "IJSRuntime bridge for data-theme.", "Web Settings"),
        new(typeof(JsBrowserColorScheme), "browser scheme JS", "IJSRuntime bridge for matchMedia.", "Web Settings"),
