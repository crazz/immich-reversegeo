...
- exact coordinate tested
- whether the issue was in Lookup or full processing
- whether the country cache was already present
- whether the app was running locally or in Docker
